...
const NutritentsInfo = ({nutrition,setNutrition}) => {
    ...
    return (
        <div className="row mt-4">
            ...
            <div className="col-lg-4 col-md-6 mb-3">
                ...
                <TextField label="Cholesterol" name="cholesterol" type="number" fullWidth size="small" value={nutrition?.cholesterol || ""} onChange={handleChange}/>

            </div>

            <div className="col-lg-4 col-md-6 mb-3">
                <TextField label="Sodium" name="sodium" type="number" fullWidth size="small" value={nutrition?.sodium || ""} onChange={handleChange}/>
            </div>
