      ...
      if (paymentMethod === "COD") {
        ...
        const options = {
          ...
          handler: function (response) {
            ...
            window.location.href = `/payment-verifying?${query}`;
          },
          prefill: {
            name: user?.uname,
            email: user?.email,
        ...
        paymentObject.on("payment.failed", function () {
          setLoading(false);
          alert("Payment Failed Plase Try Again");
        });
        paymentObject.open();
      }
    } catch (error) {
  ...
  return (
    <div className={CheckoutStyles.summaryContainer}>
      ...
      <div className={CheckoutStyles.summaryBody}>
        ...
        {discount > 0 && (
          <div
            className={`${CheckoutStyles.summaryRow} ${CheckoutStyles.discountRow}`}
          >
            <div className="d-flex flex-column">
              ...
              {couponCode && (
                <span className={CheckoutStyles.couponTag}>{couponCode}</span>
              )}
            </div>
            <span className={CheckoutStyles.discountValue}>
        ...
        <div className={CheckoutStyles.summaryRowTotal}>
          ...
          <span className={CheckoutStyles.totalValue}>
