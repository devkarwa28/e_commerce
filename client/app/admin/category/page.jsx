        ...
        <section className="container py-5" style={{ padding: "40px 20px" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "40px" }}>
                <div>
                    ...
                    <p style={{ fontSize: "16px", color: "var(--color-text-secondary, #666)", margin: 0, fontWeight: 500 }}>Organize and structure your catalog collections</p>
                </div>
                ...
                >
                    <AddRounded sx={{ fontSize: 20 }} /> Create Category
                </button>
            </div>
            ...
            <div style={{
                ...
                <div style={{ marginBottom: "32px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    >
                        ...
                        <input 
                            type="text" 
                            placeholder="Search completely by category name..." 
                            value={search}
